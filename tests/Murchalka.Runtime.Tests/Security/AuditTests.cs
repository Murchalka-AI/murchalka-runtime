...
public sealed class AuditTests
{
    ...
    public async Task AuditHashChainDetectsModificationAndRedactsSecrets()
    {
        ...
        await audit.AppendAsync("bundle.verified", "dev.murchalka.hello", "success", "valid", new Dictionary<string, string?> { ["secretToken"] = "must-not-appear" });
        ...
        await File.WriteAllTextAsync(path, text.Replace("bundle.verified", "bundle.rejected", StringComparison.Ordinal));
